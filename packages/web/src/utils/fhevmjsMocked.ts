import { fhevmConfig } from "@/utils";
import { toBigIntBE } from "bigint-buffer";
import { ethers, JsonRpcProvider, type BytesLike } from "ethers";
import { createEIP712, generateKeypair } from "fhevmjs/web";
...
const encryptValues = async (
  ...
  return {
    handles: data.handles.map((h: BytesLike) => ethers.getBytes(h)),
